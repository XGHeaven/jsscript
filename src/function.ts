...
import { JSDefinePropertyValue, JSNewPlainObject, JSObjectType, JS_PROPERTY_CONFIGURE, JS_PROPERTY_C_W, JS_PROPERTY_WRITABLE, getProtoObject, makeObject, JSNewFunction, newObjectInternal, JSHostFunctionObject } from "./object";
...
function newHostFunctionValueWithProto(ctx: Context, hostFn: HostFunction, fnName: string, argLength: number, proto: JSValue, isCtor: boolean): JSObjectValue {
...
export function JSNewHostFunctionWithProto(ctx: Context, hostFn: HostFunction, fnName: string, argLength: number, proto: JSValue) {
  return newHostFunctionValueWithProto(ctx, hostFn, fnName, argLength, proto, false)
}

export function JSNewHostConstructorWithProto(ctx: Context, hostFn: HostFunction, fnName: string, argLength: number, proto: JSValue): JSObjectValue {
